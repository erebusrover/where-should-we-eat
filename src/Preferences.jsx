      ...
      <ul>
        ...
        <RadioGroup row="true" aria-label="image" name="image">
          ...
          <FormControlLabel
            className="radio"
            value={oppossum}
            control={<PurpleRadio color="#730099" />}
            onClick={() =>
              handlePreferenceChange(
                'image',
          ...
          <FormControlLabel
            className="radio"
            value={koala}
            control={<PurpleRadio color="#9900cc" />}
            onClick={() =>
              handlePreferenceChange(
                'image',
        ...
        <RadioGroup
          defaultValue="none"
          aria-label="dietary restriction"
        ...
        >
          <FormControlLabel
            ...
            className="radio"
            value="Vegan"
            control={<PurpleRadio color="default" />}
            label="Vegan"
            onClick={() =>
              handlePreferenceChange('dietaryRestriction', 'Vegan')
            }
          />
          <FormControlLabel
            className="radio"
            ...
            label="Vegetarian"
            onClick={() =>
              handlePreferenceChange('dietaryRestriction', 'Vegetarian')
            }
          />
          <FormControlLabel
            className="radio"
            ...
            label="Kosher"
            onClick={() =>
              handlePreferenceChange('dietaryRestriction', 'Kosher')
            }
          />
          <FormControlLabel
            className="radio"
            ...
            label="Gluten Free"
            onClick={() =>
              handlePreferenceChange('dietaryRestriction', 'Gluten Free')
            }
          />
          <FormControlLabel
            className="radio"
            ...
            label="Halal"
            onClick={() =>
              handlePreferenceChange('dietaryRestriction', 'Halal')
            }
          />
          <FormControlLabel
            className="radio"
